      ...
      <div class="uk-card-header">
        <div uk-grid>
          <div class="uk-button-group uk-width-1-1">
            <a href="{{ url('/login/github') }}" class="uk-button uk-button-default uk-width-1-5 uk-padding-small">
              <span uk-icon="icon: github; ratio: 1.5"></span>
            </a>
            <a href="{{ url('/login/twitter') }}" class="uk-button uk-button-default uk-width-1-5 uk-padding-small">
              <span uk-icon="icon: twitter; ratio: 1.5"></span>
            </a>
            <a href="{{ url('/login/facebook') }}" class="uk-button uk-button-default uk-width-1-5 uk-padding-small">
              <span uk-icon="icon: facebook; ratio: 1.5"></span>
            </a>
            <a href="{{ url('/login/google') }}" class="uk-button uk-button-default uk-width-1-5 uk-padding-small">
              <span uk-icon="icon: google; ratio: 1.5"></span>
            </a>
            <a href="{{ url('/login/linkedin') }}" class="uk-button uk-button-default uk-width-1-5 uk-padding-small">
